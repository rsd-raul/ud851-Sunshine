...
//  TODO (x2) Increment the database version after altering the behavior of the table
    /*
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_WEATHER_TABLE =
                ...
                // TODO (x1) Append NOT NULL to each column's type declaration except for the _ID
                /*
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        // TODO (x3) Within onUpgrade, drop the weather table if it exists
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + WeatherEntry.TABLE_NAME);
        // TODO (x4) call onCreate and pass in the SQLiteDatabase (passed in to onUpgrade)
