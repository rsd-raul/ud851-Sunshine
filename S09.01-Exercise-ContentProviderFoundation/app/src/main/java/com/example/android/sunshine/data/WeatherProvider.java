...
//  TODO (x5) Create static constant integer values named CODE_WEATHER & CODE_WEATHER_WITH_DATE to identify the URIs this ContentProvider can handle
    public static final int CODE_WEATHER = 100;
    public static final int CODE_WEATHER_WITH_DATE = 101;

//  TODO (x7) Instantiate a static UriMatcher using the buildUriMatcher method
    private static final UriMatcher sUriMatcher = buildUriMatcher();

    WeatherDbHelper mOpenHelper;

//  TODO (x6) Write a method called buildUriMatcher where you match URI's to their numeric ID
...
//  TODO (x1) Implement onCreate
    @Override
    public boolean onCreate() {
//      TODO (x2) Within onCreate, instantiate our mOpenHelper
        mOpenHelper = new WeatherDbHelper(getContext());

//      TODO (x3) Return true from onCreate to signify success performing setup
        return true;
    }
...
//  TODO (x8) Provide an implementation for the query method
    /**
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        // TODO (x9) Handle queries on both the weather and weather with date URI
        switch(sUriMatcher.match(uri)){
            case CODE_WEATHER:
                response = db.query(WeatherContract.WeatherEntry.TABLE_NAME, projection,
                        selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case CODE_WEATHER_WITH_DATE:
                // Retrieve the id, knowing the Uri has 2 paths "/weather/date" we get the date
        ...
        // TODO (x10) Call setNotificationUri on the cursor and then return the cursor
